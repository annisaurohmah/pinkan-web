				...
				<div class="row">
					<div class="col-12">
						<div class="single-main">
							<!-- News Title -->
							<h1 class="news-title">Instalasi Akun PINKAN</a></h1>
							<!-- Meta -->
							<div class="meta">
								<div class="meta-left">
							...
							<!-- News Text -->
							<div class="news-text">
							<p> Masuk ke website PINKAN </p>
								<p> Klik menu Unduh</p>
								<p> Klik tombol Unduh Aplikasi pada jenis aplikasi yang ingin diunduh </p>
								<p> Tunggu hingga proses unduh selesai </p>
							</div>
