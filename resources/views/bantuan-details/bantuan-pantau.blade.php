				...
				<div class="row">
					<div class="col-12">
						<div class="single-main">
							<!-- News Title -->
							<h1 class="news-title">Cara Memonitor Progress Menggunakan Dashboard</a></h1>
							<!-- Meta -->
							<div class="meta">
								<div class="meta-left">
							...
							<!-- News Text -->
							<div class="news-text">
								<p>Untuk memantau progres pengguna, dapat dengan masuk ke akun yang terdaftar pada Pinkan dan melihat hasil pencatatan di dashboard website</p>
							</div>
