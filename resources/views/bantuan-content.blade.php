				...
				<div class="row">
					<div class="col-12">
						<div class="single-main">
							<!-- News Title -->
							<h1 class="news-title">Cara Membuat Akun PINKAN</a></h1>
							<!-- Meta -->
							<div class="meta">
								<div class="meta-left">
				...
				<div class="main-sidebar">
					...
					<div class="single-widget category">
						...
						<ul class="categor-list">
							...
							<a href="{{ route('detail-bantuan') }}" class="text-blue">Bagaimana cara menghapus akun PINKAN?</a><br>
							...
							<a href="{{ route('detail-bantuan') }}" class="text-blue">Memantau progress melalui dashboard web</a><br>
							<a href="{{ route('detail-bantuan') }}" class="text-blue">Persyaratan Perangkat</a><br>
							<a href="{{ route('detail-bantuan') }}" class="text-blue">Laporkan masalah</a><br>
