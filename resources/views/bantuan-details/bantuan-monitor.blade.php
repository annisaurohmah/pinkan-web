				...
				<div class="row">
					<div class="col-12">
						<div class="single-main">
							<!-- News Title -->
							<h1 class="news-title">Cara Memainkan PINKAN dengan Monitor</a></h1>
							<!-- Meta -->
							<div class="meta">
								<div class="meta-left">
							...
							<!-- News Text -->
							<div class="news-text">
								<p>Hubungkan laptop dengan monitor menggunakan kabel yang sesuai</p>
								<p>Hubungkan monitor dengan sumber listrik</p>
								<p>Nyalakan monitor</p>
								<p>Nyalakan laptop</p>
								<p>Setelah laptop menyala, klik kanan pada desktop</p>
								<p>Pilih opsi tampilan</p>
								<p>Pilih opsi tampilan yang sesuai dengan monitor</p>
								<p>Klik tombol Apply</p>
								<p>Klik tombol OK</p>
								<p>Selesai</p>
							</div>
