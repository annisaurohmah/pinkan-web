					...
					<div class="col-lg-4 col-12">
						...
						<div class="single-features">
							<div class="signle-icon">
								<i id="icon-1" class="icofont-game-controller"></i>
							</div>
							<h3>Belajar Berbasis Game</h3>
							<p>Belajar seru dan menyenangkan dengan permainan</p>
						</div>
						<!-- End Single features -->
					</div>
					<div class="col-lg-4 col-12">
						...
						<div class="single-features">
							<div class="signle-icon">
								<i id="icon-2" class="icofont-computer"></i>
							</div>
							<h3>Terintegrasi Teknologi Computer Vision</h3>
							<p>Kontrol game dengan Computer Vision yang melatih motorik anak ADHD</p>
						</div>
						<!-- End Single features -->
					</div>
					<div class="col-lg-4 col-12">
						...
						<div class="single-features last">
							<div class="signle-icon">
								<i id="icon-3" class="icofont-ui-browser"></i>
							</div>
							<h3>Sistem Monitoring Progres Belajar</h3>
							<p>Pantau progres belajar dari mana saja melalui dashboard PINKAN</p>
						</div>
						<!-- End Single features -->
					</div>
				</div>
