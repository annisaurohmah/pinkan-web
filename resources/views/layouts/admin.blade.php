...
<head>
    ...
    <meta name="description" content="PINKAN Dashboard">
    <meta name="author" content="PINKAN Team">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center bg-white">
                <div class="sidebar-brand-icon">
                    <img src="{{ asset('img/logo.svg') }}" alt="PINKAN Logo" width="30px" height="30px">
                </div>
                <div class="sidebar-brand-text mx-3">PINKAN</div>
            </a>
            ...
            <li class="nav-item ">
                <a class="nav-link" href="{{ route('baca') }}">
                    <i class="fas fa-fw fa-book"></i>
                    <span>{{ __('Game Membaca') }}</span></a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="{{ route('hitung') }}">
                    <i class="fas fa-fw fa-calculator"></i>
                    <span>{{ __('Game Berhitung') }}</span></a>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; PINKAN {{ now()->year }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
